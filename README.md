...
Welcome to my React and Node side project to build a fully-functional e-commerce website exactly like amazon.
...
```
$ git clone git@github.com:i-rasheed/amazon-clone-rasheed.git
$ cd amazona
```
